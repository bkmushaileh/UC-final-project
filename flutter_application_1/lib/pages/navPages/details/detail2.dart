...
class DetailTwoPage extends StatefulWidget {
  DetailTwoPage({super.key});

  @override
  State<DetailTwoPage> createState() => _DetailTwoPageState();
}
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/m3.jpg"), fit: BoxFit.fitWidth),
                ),
              ),
            ),
            Container(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppText(
                      text:
                          "FULL MOON YIN YOGA AND SHARING CIRCLE WORKSHOP this workshop will start with a 45 mins yun yoga and will be followed by creating mandalas from natural materials and will be ended with gathering in acircle to share challanges and achivements from the past year and reflecting on the new year goals intentions",
                      color:
                          Color.fromARGB(255, 154, 152, 152).withOpacity(0.8),
                      size: 13,
                    )
